...
$('.title-content-da-index').slick({
    ...
    autoplaySpeed: 2500,
    fade: false,
    asNavFor: '.slide-big1,.slide-left,.slide-big',
});
...
$('.slide-big').slick({
    ...
    fade: false,
    Swipe: true,
    asNavFor: '.slide-big1,.slide-left,.title-content-da-index',
});
$('.slide-big1').slick({
    slidesToShow: 5,
    slidesToScroll: 1,
    ...
    Swipe: true,
    fade: false,
    asNavFor: '.slide-big,.slide-left,.title-content-da-index',
    responsive: [
        {
            breakpoint: 1300,
            settings:
...
$('.slide-left').slick({
    ...
    autoplaySpeed: 3000,
    fade: false,
    asNavFor: '.slide-big,.slide-big1,.title-content-da-index',
});
